...
https://github.com/evidentlyai/evidently/blob/main/docs/book/reference/all-metrics.md
...
* 10
* 12.5
* 14.2 14.2 confirmad in Grafana dashboard.
* 14.8
...
* `project_folder/dashboards`  (05-monitoring/dashboards) save it here!
